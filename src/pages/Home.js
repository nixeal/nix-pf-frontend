...
export default function Home() {
    return (
        <>
            <div className="container bg-dark text-white col-xxl-8 px-4 py-5">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                            ...
                            <button type="button" className="btn btn-outline-secondary btn-lg px-4">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className='container m-auto me-auto'
                style={
                    {textAlign: 'left'}
            }>
                ...
                <div className='blogpost-seg mb-4'>
                    <h3 className='mb-2'>Blog Posts</h3>
                    <div className='row'>
                ...
                <div className='newsletter-div'>
                    ...
                    <button type="button"
                        ...
                        className="btn btn-outlined-secondary text-dark btn-lg border hover">Subscribe</button>
                </div>
            </div>
        </>
    )
